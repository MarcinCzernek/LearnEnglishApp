...
public class PlayerFunctions {
    ...
    public static final String RAW_MEDIA_SAMPLE = "test_song";

    // Example Path: /sdcard/Music/mysong.mp3
    // Example Path: /storage/emulated/0/DCIM/Music/mysong.mp3
    public static final String LOCAL_MEDIA_SAMPLE ="/sdcard/Music/test_song.mp3";
    ...
    public static void playRawMedia(Context context, MediaPlayer mediaPlayer, String resName)  {
        try {
            // ID of video file.
            int id = PlayerFunctions.getRawResIdByName( context,resName);
