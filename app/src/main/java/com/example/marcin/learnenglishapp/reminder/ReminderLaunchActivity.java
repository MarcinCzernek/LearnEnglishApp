...
public class ReminderLaunchActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_reminder_launch);
        ...
        Cursor cursor = new Database(getApplicationContext()).readallreminders();                  //Cursor To Load data From the database
