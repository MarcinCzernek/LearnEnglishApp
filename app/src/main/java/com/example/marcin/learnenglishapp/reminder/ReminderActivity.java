...
public class ReminderActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDatebtn = (Button) findViewById(R.id.data_Button);                                             //assigned all the material reference to get and set data
        mTimebtn = (Button) findViewById(R.id.time_Button);
        mSubmitbtn = (Button) findViewById(R.id.save_Button);
    ...
    private void processinsert(String title, String date, String time) {
        String result = new Database(this).addreminder(title, date, time);                  //inserts the title,date,time into sql lite database
    ...
    private void setAlarm(String text, String date, String time) {
        ...
        Intent intentBack = new Intent(getApplicationContext(), ReminderLaunchActivity.class);                //this intent will be called once the setting alaram is completes
